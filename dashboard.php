...
<body>
    ...
    <section class="center_part">
        <div class="Links">
            <img src="./large_Kalasalingam_Academy_of_Research_and_Education_Virudhunagar_aeb7350844_a1649b2e88 (1).png" height="70%" width="90%">
            <a href="#" class="links">Dashboard </a>
            <a href="./generateQuiz.html">Generate Quiz</a>
        ...
        <div class="cards">
            <a href="./generateQuiz.php">
                <div class="cards1">
                    <img src="./Quiz-comic-pop-art-style-illustration-on-transparent-background-PNG.png" width="90px" height="90px">
                    <h3>Generate Quiz</h3>
            </a>
        </div>
        <a href="./schedulequiz.php">
            <div class="cards2">
                <img src="./quiz.png" width="90%" height="70%">
                <h3>Schedule Quiz</h3>
            </div>
        </a>
        </div>
        ...
        <div class="card1">
            <a href="#">
                <div class="cards3">
                    <img src="./quiz (1).png" width="90px" height="90px"><br>
                    <h3>Edit Generated Quiz</h3>
                </div>
            </a>
            <a href="#">
                <div class="cards4">
                    <img src="./result.png" width="90px" height="90px"><br>
                    <h3>View Marks</h3>
                </div>
            </a>
        </div>
